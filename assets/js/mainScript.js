...
let mburger = document.getElementById('main-burger')
let mainNav = document.getElementById('ul-holder')
...
// Mobile Main Nav
function remove_main_nav(){
    if (mainNavNav.classList.contains('showNav')){
...
// Activates the main mobile nav links
